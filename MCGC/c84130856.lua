...
function c84130856.initial_effect(c)
    -- Activate
...
function c84130856.cfilter(c)
    return c:IsFaceup() and c:IsCode(84130811) or c:IsCode(84130839)
end

function c84130856.filter(c)
...
function c84130856.target(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
    ...
    local g = Duel.SelectTarget(tp, c84130856.filter, tp, LOCATION_MZONE, LOCATION_MZONE, 1, 1, nil)
    Duel.SetOperationInfo(0, CATEGORY_DESTROY, g, 1, 0, 0)
    Duel.SetOperationInfo(0, CATEGORY_DAMAGE, nil, 0, PLAYER_ALL, 0)
end

function c84130856.activate(e, tp, eg, ep, ev, re, r, rp)
