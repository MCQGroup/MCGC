...
COUNTER_NEED_ENABLE = 0x2000    -- 放在自己身上的指示物(卡片守卫)
...
EFFECT_FLAG_CANNOT_NEGATED      = 0x0200        -- 含有"此效果不会被无效"的叙述
...
EFFECT_FLAG_DELAY               = 0x10000       -- 场合型诱发效果，用于永续效果的 EFFECT_TYPE_CONTINIOUS(不会被卡时点
