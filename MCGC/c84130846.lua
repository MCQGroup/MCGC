...
function c84130846.initial_effect(c)
    ...
    e3:SetOperation(c84130811.searchOperation)
    c:RegisterEffect(e3)
...
function c84130846.replaceTarget(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
    ...
    if Duel.SelectYesNo(tp, aux.Stringid(84130846, 1)) then
...
function c84130846.searchTarget(e, tp, eg, ep, ev, re, r, rp, chk, chkc)
    ...
    local g = Duel.SelectMatchingCard(tp, c84130846.searchFilter, tp, LOCATION_DECK + LOCATION_GRAVE, 1, 1, nil)
