...
function Auxiliary.FConditionCode2(code1, code2, sub, insf)
    ...
    return function(e, g, gc, chkf)
        ...
        while tc do
            ...
            if code == code1 then
                b1 = 1
                if Auxiliary.FConditionCheckF(tc, chkf) then f1 = true end
            elseif code == code2 then
                b2 = 1
                if Auxiliary.FConditionCheckF(tc, chkf) then f2 = true end
            elseif tc:IsHasEffect(EFFECT_FUSION_SUBSTITUTE) then
                bs = 1
        ...
        if chkf ~= PLAYER_NONE then
            if sub then
                return(b1 ~= 0 and f1 and b2 + bs ~= 0) or(b2 ~= 0 and f2 and b1 + bs ~= 0) or(bs ~= 0 and fs and b1 + b2 ~= 0)
            else
                return(b1 ~= 0 and f1 and b2 == 1) or(b2 ~= 0 and f2 and b1 == 1)
            end
        else
            if sub then
                return b1 + b2 + bs > 1
...
function Auxiliary.FConditionCode3(code1, code2, code3, sub, insf)
    return function(e, g, gc, chkf)
        ...
        while tc do
            ...
            elseif code == code3 then
                b3 = 1
                if Auxiliary.FConditionCheckF(tc, chkf) then f3 = true end
            elseif tc:IsHasEffect(EFFECT_FUSION_SUBSTITUTE) then
                bs = 1
                if Auxiliary.FConditionCheckF(tc, chkf) then fs = true end
            end
        ...
        if chkf ~= PLAYER_NONE then
            if sub then
                return(b1 ~= 0 and f1 and b2 + b3 + bs > 1) or(b2 ~= 0 and f2 and b1 + b3 + bs > 1)
                or(b3 ~= 0 and f3 and b1 + b2 + bs > 1) or(bs ~= 0 and fs and b1 + b2 + b3 > 1)
            else
                return(b1 ~= 0 and f1 and b2 + b3 == 2) or(b2 ~= 0 and f2 and b1 + b3 == 2)
                or(b3 ~= 0 and f3 and b1 + b2 == 2)
            end
        else
            if sub then
                return b1 + b2 + b3 + bs > 2
            else
                return b1 + b2 + b3 == 3
            end
        end
...
function Auxiliary.FConditionCode4(code1, code2, code3, code4, sub, insf)
    return function(e, g, gc, chkf)
        ...
        while tc do
            ...
            elseif code == code4 then
                b4 = 1
                if Auxiliary.FConditionCheckF(tc, chkf) then f4 = true end
            elseif tc:IsHasEffect(EFFECT_FUSION_SUBSTITUTE) then
                bs = 1
                if Auxiliary.FConditionCheckF(tc, chkf) then fs = true end
            end
        ...
        if chkf ~= PLAYER_NONE then
            if sub then
                return(b1 ~= 0 and f1 and b2 + b3 + b4 + bs > 2) or(b2 ~= 0 and f2 and b1 + b3 + b4 + bs > 2)
                or(b3 ~= 0 and f3 and b1 + b2 + b4 + bs > 2) or(b4 ~= 0 and f4 and b1 + b2 + b3 + bs > 2)
                or(bs ~= 0 and fs and b1 + b2 + b3 + b4 > 2)
            else
                return(b1 ~= 0 and f1 and b2 + b3 + b4 == 3) or(b2 ~= 0 and f2 and b1 + b3 + b4 == 3)
                or(b3 ~= 0 and f3 and b1 + b2 + b4 == 3) or(b4 ~= 0 and f4 and b1 + b2 + b3 == 3)
            end
        else
            if sub then
                return b1 + b2 + b3 + b4 + bs > 3
            else
...
function Auxiliary.FConditionCodeFun(code, f, cc, sub, insf)
    return function(e, g, gc, chkf)
        if g == nil then return insf end
        if gc then
            return(gc:IsCode(code) or(sub and gc:IsHasEffect(EFFECT_FUSION_SUBSTITUTE)))
            and g:IsExists(f, cc, nil)
        end
        ...
        if chkf ~= PLAYER_NONE then
            ...
            return g1:IsExists(Auxiliary.FConditionFilterCF, 1, nil, g2, cc)
        end
    end
end
